...
function Login() {
  ...
  function handleSubmit(event) {
    ...
    fetch('https://gas-flask-app.onrender.com/login', {
      method: 'POST',
      headers: {
    ...
    .then(resp => {
      if (resp.ok) {
        ...
        .then(newUser => {
          ...
          setUser(newUser);
          // Navigate to the dash after user state has been updated
          if (newUser.email) {
            navigate('/dash', { state: { user: newUser } });
          }
        });
      } else {
  ...
  return (
    <div>
      <h1 className='login-greeting'>Welcome Back Please Sign In</h1>
    <div className='login-container'>
      ...
      <form onSubmit={handleSubmit} className="form_main">
        ...
        <div className="inputContainer">
            ...
            <input type="email" className="inputField" id="username" placeholder="Email"
        value={username}
